...
| **3** | Mar 18 | **Inference & long context**: KV-cache, attention variants (MQA, GQA, MLA), prefill vs. decode, long-context bottlenecks, speculative decoding, Optional: MoE | [Slides](./lecture3/slides/lecture3_handout.pdf) |
